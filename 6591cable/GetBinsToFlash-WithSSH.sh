    ...
    do
      case $choice in
        ...
        1)
          ...
          echo ""
          mkdir -p /mnt/c/FritzBox/6591cable/BinsToFlash/7.22-Deustchland-WithSSH/ 2> /dev/null
          ...
          mv /root/SourceCode/ffritz/images/BinsWithSSH/mtd1-Atom-Kernel.bin         /mnt/c/FritzBox/6591cable/BinsToFlash/7.22-Deustchland-WithSSH/mtd1.bin
          mv /root/SourceCode/ffritz/images/BinsWithSSH/mtd6-ARM-RootFileSystem.bin  /mnt/c/FritzBox/6591cable/BinsToFlash/7.22-Deustchland-WithSSH/mtd6.bin
          mv /root/SourceCode/ffritz/images/BinsWithSSH/mtd7-ARM-Kernel.bin          /mnt/c/FritzBox/6591cable/BinsToFlash/7.22-Deustchland-WithSSH/mtd7.bin
          wget --no-check-certificate https://raw.githubusercontent.com/PeterPawn/YourFritz/master/eva_tools/EVA-Discover.ps1   -O /mnt/c/FritzBox/6591cable/BinsToFlash/7.22-Deustchland-WithSSH/EVA-Discover.ps1
          wget --no-check-certificate https://raw.githubusercontent.com/PeterPawn/YourFritz/master/eva_tools/EVA-FTP-Client.ps1 -O /mnt/c/FritzBox/6591cable/BinsToFlash/7.22-Deustchland-WithSSH/EVA-FTP-Client.ps1
          echo ""
          echo "c:\FritzBox\6591cable\BinsToFlash\7.22-Deustchland-WithSSH\EVA-Discover.ps1" > /mnt/c/FritzBox/6591cable/BinsToFlash/7.22-Deustchland-WithSSH/FlashWithSSH.ps1
          echo "c:\FritzBox\6591cable\BinsToFlash\7.22-Deustchland-WithSSH\EVA-FTP-Client.ps1 -Verbose -Debug -ScriptBlock { GetEnvironmentFile env }" >> /mnt/c/FritzBox/6591cable/BinsToFlash/7.22-Deustchland-WithSSH/FlashWithSSH.ps1
          echo "c:\FritzBox\6591cable\BinsToFlash\7.22-Deustchland-WithSSH\EVA-FTP-Client.ps1 -Verbose -Debug -ScriptBlock { UploadFlashFile c:\FritzBox\6591cable\BinsToFlash\7.22-Deustchland-WithSSH\mtd0.bin mtd0 }" >> /mnt/c/FritzBox/6591cable/BinsToFlash/7.22-Deustchland-WithSSH/FlashWithSSH.ps1
          echo "c:\FritzBox\6591cable\BinsToFlash\7.22-Deustchland-WithSSH\EVA-FTP-Client.ps1 -Verbose -Debug -ScriptBlock { UploadFlashFile c:\FritzBox\6591cable\BinsToFlash\7.22-Deustchland-WithSSH\mtd1.bin mtd1 }" >> /mnt/c/FritzBox/6591cable/BinsToFlash/7.22-Deustchland-WithSSH/FlashWithSSH.ps1
          echo "c:\FritzBox\6591cable\BinsToFlash\7.22-Deustchland-WithSSH\EVA-FTP-Client.ps1 -Verbose -Debug -ScriptBlock { UploadFlashFile c:\FritzBox\6591cable\BinsToFlash\7.22-Deustchland-WithSSH\mtd6.bin mtd6 }" >> /mnt/c/FritzBox/6591cable/BinsToFlash/7.22-Deustchland-WithSSH/FlashWithSSH.ps1
        ...
        2)
          ...
          echo -e "${ColorGreen}Moving files to windows folders...${ColorEnd}"
          echo ""
          mkdir -p /mnt/c/FritzBox/6591cable/BinsToFlash/7.22-International-WithSSH/ 2> /dev/null
          ...
          mv /root/SourceCode/ffritz/images/BinsWithSSH/mtd1-Atom-Kernel.bin         /mnt/c/FritzBox/6591cable/BinsToFlash/7.22-International-WithSSH/mtd1.bin
          mv /root/SourceCode/ffritz/images/BinsWithSSH/mtd6-ARM-RootFileSystem.bin  /mnt/c/FritzBox/6591cable/BinsToFlash/7.22-International-WithSSH/mtd6.bin
          mv /root/SourceCode/ffritz/images/BinsWithSSH/mtd7-ARM-Kernel.bin          /mnt/c/FritzBox/6591cable/BinsToFlash/7.22-International-WithSSH/mtd7.bin
          wget --no-check-certificate https://raw.githubusercontent.com/PeterPawn/YourFritz/master/eva_tools/EVA-Discover.ps1   -O /mnt/c/FritzBox/6591cable/BinsToFlash/7.22-International-WithSSH/EVA-Discover.ps1
          wget --no-check-certificate https://raw.githubusercontent.com/PeterPawn/YourFritz/master/eva_tools/EVA-FTP-Client.ps1 -O /mnt/c/FritzBox/6591cable/BinsToFlash/7.22-International-WithSSH/EVA-FTP-Client.ps1
          echo ""
          echo "c:\FritzBox\6591cable\BinsToFlash\7.22-International-WithSSH\EVA-Discover.ps1" > /mnt/c/FritzBox/6591cable/BinsToFlash/7.22-International-WithSSH/FlashWithSSH.ps1
          echo "c:\FritzBox\6591cable\BinsToFlash\7.22-International-WithSSH\EVA-FTP-Client.ps1 -Verbose -Debug -ScriptBlock { GetEnvironmentFile env }" >> /mnt/c/FritzBox/6591cable/BinsToFlash/7.22-International-WithSSH/FlashWithSSH.ps1
          echo "c:\FritzBox\6591cable\BinsToFlash\7.22-International-WithSSH\EVA-FTP-Client.ps1 -Verbose -Debug -ScriptBlock { UploadFlashFile c:\FritzBox\6591cable\BinsToFlash\7.22-International-WithSSH\mtd0.bin mtd0 }" >> /mnt/c/FritzBox/6591cable/BinsToFlash/7.22-International-WithSSH/FlashWithSSH.ps1
          echo "c:\FritzBox\6591cable\BinsToFlash\7.22-International-WithSSH\EVA-FTP-Client.ps1 -Verbose -Debug -ScriptBlock { UploadFlashFile c:\FritzBox\6591cable\BinsToFlash\7.22-International-WithSSH\mtd1.bin mtd1 }" >> /mnt/c/FritzBox/6591cable/BinsToFlash/7.22-International-WithSSH/FlashWithSSH.ps1
          echo "c:\FritzBox\6591cable\BinsToFlash\7.22-International-WithSSH\EVA-FTP-Client.ps1 -Verbose -Debug -ScriptBlock { UploadFlashFile c:\FritzBox\6591cable\BinsToFlash\7.22-International-WithSSH\mtd6.bin mtd6 }" >> /mnt/c/FritzBox/6591cable/BinsToFlash/7.22-International-WithSSH/FlashWithSSH.ps1
