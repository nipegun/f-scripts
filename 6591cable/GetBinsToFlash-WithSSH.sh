    ...
    do
      case $choice in
        ...
        1)
          ...
          echo ""
          mkdir -p /mnt/c/FritzBox/6591cable/BinsToFlash/7.22deustchland/WithSSH/ > /dev/null
          mv /root/SourceCode/ffritz/images/BinsWithSSH/mtd0-Atom-RootFileSystem.bin /mnt/c/FritzBox/6591cable/BinsToFlash/7.22deustchland/WithSSH/mtd0.bin
          mv /root/SourceCode/ffritz/images/BinsWithSSH/mtd1-Atom-Kernel.bin         /mnt/c/FritzBox/6591cable/BinsToFlash/7.22deustchland/WithSSH/mtd1.bin
          mv /root/SourceCode/ffritz/images/BinsWithSSH/mtd6-ARM-RootFileSystem.bin  /mnt/c/FritzBox/6591cable/BinsToFlash/7.22deustchland/WithSSH/mtd6.bin
          mv /root/SourceCode/ffritz/images/BinsWithSSH/mtd7-ARM-Kernel.bin          /mnt/c/FritzBox/6591cable/BinsToFlash/7.22deustchland/WithSSH/mtd7.bin
          ...
          echo ""
          echo "c:\FritzBox\6591cable\BinsToFlash\7.22deustchland\EVA-Discover.ps1" > /mnt/c/FritzBox/6591cable/BinsToFlash/7.22deustchland/FlashWithSSH.ps1
          echo "c:\FritzBox\6591cable\BinsToFlash\7.22deustchland\EVA-FTP-Client.ps1 -Verbose -Debug -ScriptBlock { GetEnvironmentFile env }" >> /mnt/c/FritzBox/6591cable/BinsToFlash/7.22deustchland/FlashWithSSH.ps1
          echo "c:\FritzBox\6591cable\BinsToFlash\7.22deustchland\EVA-FTP-Client.ps1 -Verbose -Debug -ScriptBlock { UploadFlashFile c:\FritzBox\6591cable\BinsToFlash\7.22deustchland\WithSSH\mtd0.bin mtd0 }" >> /mnt/c/FritzBox/6591cable/BinsToFlash/7.22deustchland/FlashWithSSH.ps1
          echo "c:\FritzBox\6591cable\BinsToFlash\7.22deustchland\EVA-FTP-Client.ps1 -Verbose -Debug -ScriptBlock { UploadFlashFile c:\FritzBox\6591cable\BinsToFlash\7.22deustchland\WithSSH\mtd1.bin mtd1 }" >> /mnt/c/FritzBox/6591cable/BinsToFlash/7.22deustchland/FlashWithSSH.ps1
          echo "c:\FritzBox\6591cable\BinsToFlash\7.22deustchland\EVA-FTP-Client.ps1 -Verbose -Debug -ScriptBlock { UploadFlashFile c:\FritzBox\6591cable\BinsToFlash\7.22deustchland\WithSSH\mtd6.bin mtd6 }" >> /mnt/c/FritzBox/6591cable/BinsToFlash/7.22deustchland/FlashWithSSH.ps1
          echo "c:\FritzBox\6591cable\BinsToFlash\7.22deustchland\EVA-FTP-Client.ps1 -Verbose -Debug -ScriptBlock { UploadFlashFile c:\FritzBox\6591cable\BinsToFlash\7.22deustchland\WithSSH\mtd7.bin mtd7 }" >> /mnt/c/FritzBox/6591cable/BinsToFlash/7.22deustchland/FlashWithSSH.ps1
          echo "c:\FritzBox\6591cable\BinsToFlash\7.22deustchland\EVA-FTP-Client.ps1 -Verbose -Debug -ScriptBlock { RebootTheDevice }" >> /mnt/c/FritzBox/6591cable/BinsToFlash/7.22deustchland/FlashWithSSH.ps1
          echo ""
          echo "All files copied to c:\FritzBox\6591cable\BinsToFlash\7.22deustchland\ "
          echo ""
          echo "Open PowerShell as Administrator and run:"
          echo "c:\FritzBox\6591cable\BinsToFlash\7.22deustchland\FlashWithSSH.ps1"
          echo ""
          exit
